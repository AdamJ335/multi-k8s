...
kubectl set image deployments/client-deployment server=adamj335/multi-client:$SHA
kubectl set image deployments/worker-deployment server=adamj335/multi-worker:$SHA
